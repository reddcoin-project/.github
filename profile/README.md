...
- [ReddCoin Core](https://github.com/reddcoin-project/reddcoin)
- [Node API](https://github.com/reddcoin-project/reddcoin-node-api)
...
ReddCoin Core is released under the MIT License.
